...
def plot_differ(energy_vasp,energy_model,energy_chg):
    ...
    plt.show()
    return
# energy_vasp,energy_model,energy_chg=both('D:\桌面\VASP\YST-1',"D:\桌面\CHG\\bestE_epoch2_e6_f43_s35_mNA.pth.tar")
# data = {
# 'vasp':energy_vasp,
# 'model':energy_model,
# 'chg':energy_chg
...
# with open("D:\桌面\data.json",'w') as json_file:
#     json.dump(data,json_file)
with open("D:\桌面\data.json",'r') as json_file:
    energy_lis=json.load(json_file)
print(energy_lis.keys())
plot_differ(energy_lis['vasp'],energy_lis['model'],energy_lis['chg'])